export default {
  ...
  CE: {
    ...
    servicos: {
      autorizacao: {
        ...
        url_homologacao:
          'https://nfeh.sefaz.ce.gov.br/nfe4/services/NFeAutorizacao4?WSDL',
      },
      retAutorizacao: {
        url_producao:
  ...
  MS: {
    ...
    servicos: {
      ...
      recepcaoEvento: {
        url_producao: 'https://nfe.sefaz.ms.gov.br/ws/NFeRecepcaoEvento4',
        url_homologacao:
  ...
  PR: {
    ...
    servicos: {
      ...
      recepcaoEvento: {
        url_producao: 'https://nfe.sefa.pr.gov.br/nfe/NFeRecepcaoEvento4?wsdl',
        url_homologacao:
