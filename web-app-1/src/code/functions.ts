import { getFunctions, connectFunctionsEmulator, httpsCallable, FunctionsError } from 'firebase/functions'

const functions = getFunctions(undefined, 'southamerica-east1')
connectFunctionsEmulator(functions, 'localhost', 5001)
export const precadastro = httpsCallable(functions, 'precadastro')
const _gerarDANFENFe = httpsCallable(functions, 'gerarDANFENFe')
const _transmitirNFe = httpsCallable(functions, 'transmitirNFe')
const _cancelarNFe = httpsCallable(functions, 'cancelarNFe')
